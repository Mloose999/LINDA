  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        <p className="text-gold font-semibold text-lg md:text-xl tracking-widest uppercase mb-4">Change Your Life with Linda</p>
        <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl font-extrabold text-card leading-tight text-balance mb-6">
          Giving up is not an option
        </h1>
        <p className="text-gold/90 italic text-lg mb-8">It starts with you</p>
